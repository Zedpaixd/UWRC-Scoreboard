...
timer = switch = lr = team1ScoreTemp = team2ScoreTemp = resetSeconds = 0
...
session = ftplib.FTP('yeah','i am not gonna','share this')  #Starting the session; website,username,password
